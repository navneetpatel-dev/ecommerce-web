 ...
 */
export function renderVendorRowActions({ row, onReload }: VendorRowActionsProps): ReactNode {
  ...
  return (
    <>
      ...
      <AdminConfirmAction
        ...
        onConfirm={(reason) => adminApi.suspendVendor(vendorId, reason ?? '').then(onReload)}
      />
      <AdminConfirmAction
        label={LABELS.delete}
