      ...
      >
        ...
        >
          <TabsTrigger
            value="platform"
            className={cn(
              'rounded-sm px-4 py-2.5 text-[0.8125rem] text-ink-muted hover:text-ink',
        ...
        <TabsContent value="platform" className="mt-6 min-w-0 focus-visible:outline-none">
          <CouponsTable
        ...
        <TabsContent value="vendor" className="mt-6 min-w-0 focus-visible:outline-none">
          <CouponsTable
            coupons={page.coupons}
            loading={page.isLoading}
            pagination={page.pagination}
