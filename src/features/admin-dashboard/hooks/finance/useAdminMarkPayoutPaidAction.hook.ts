...
export const PAYOUT_PAYMENT_METHODS: readonly PayoutPaymentMethod[] = [
  "NEFT",
  "IMPS",
  "UPI",
  "RTGS",
...
interface UseAdminMarkPayoutPaidActionParams {
  payoutId: string;
  onDone: () => void;
}

export function useAdminMarkPayoutPaidAction({
  payoutId,
  onDone,
}: UseAdminMarkPayoutPaidActionParams) {
  ...
  const handleMethodChange = (value: string) => {
    setMethod(value as PayoutPaymentMethod);
  };
