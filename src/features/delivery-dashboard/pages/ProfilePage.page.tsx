...
/**
 * Field-operations controls (availability, push alerts) plus the shared
 * workspace account page (Personal/Security/Privacy — same as admin/vendor)
 * so an agent can actually sign out or manage their password, which the
 * bespoke version of this page never offered.
 */
