...
import type { CategoryRootWithChildren } from "../hooks/useCategoriesPage.hook";
      ...
      {isEmpty ? (
        <div className="rounded-md border border-line bg-surface px-6 py-16 text-center">
          <LayoutGrid
            ...
            strokeWidth={1.25}
          />
          <p className="mt-4 text-body-lg font-medium text-ink">
            {LABELS.noCategoriesYet}
          </p>
          <Link
            href={PATHS.products}
            className="mt-3 inline-flex items-center gap-1 text-body text-brand"
          >
