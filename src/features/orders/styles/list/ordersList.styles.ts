export const ORDERS_LIST_STYLES = {
  ...
  tableMargin: "mt-8",
  itemsCell: "min-w-0",
  itemsSummary: "lg:truncate text-body text-ink group-hover:text-brand",
  itemsCountText: "mt-0.5 text-[0.75rem] text-ink-faint",
  totalAmount: "font-display text-[1.125rem] tabular-nums text-ink",
  orderCell: "flex items-baseline justify-between gap-3 lg:block",
  orderId: "min-w-0 font-mono text-body-sm",
  mobileTotal:
    "shrink-0 font-display text-[1.125rem] tabular-nums text-ink lg:hidden",
  openIcon:
    "ml-auto h-4 w-4 text-ink-faint transition-transform duration-200 group-hover:translate-x-0.5 group-hover:text-brand",
  srOnly: "sr-only",
  colOrderHeader: "lg:w-[10%]",
  colOrderCell: "lg:w-[10%] font-mono text-body-sm",
  colPlacedHeader: "lg:w-[12%]",
  colPlacedCell: "lg:w-[12%] text-ink-muted",
  colItemsHeader: "lg:w-[38%]",
  colItemsCell: "lg:w-[38%]",
  colTotalHeader: "lg:w-[14%] text-right",
  colTotalCell: "lg:w-[14%] text-right",
  colStatusHeader: "lg:w-[22%]",
  colStatusCell: "lg:w-[22%]",
  colOpenHeader: "lg:w-[4%]",
  colOpenCell: "lg:w-[4%] text-right",
} as const;
