 ...
 *
 * Mirrors `features/admin-dashboard/utils/chartTheme.ts` — duplicated locally
 * rather than cross-imported because cross-feature imports must go through the
 * other feature's index.ts barrel (Rule 15), and this util isn't part of it.
 */
