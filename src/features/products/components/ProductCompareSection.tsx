...
export const ProductCompareSection = forwardRef<HTMLElement, ProductCompareSectionProps>(
  function ProductCompareSection({ products }, ref) {
    if (products.length < 2) return null

    return (
      <section ref={ref} className="mt-12 rounded-lg border border-line bg-surface p-6">
        <div className="mb-6">
