export const bugReportsPagesStyles = {
  ...
  vendorCreateButton: "shrink-0",
  vendorNewBugContainer: "w-full min-w-0",
  ...
  customerNewBugContainer: "storefront-container py-8 md:py-10",
  ...
  customerDetailContainer:
    "storefront-container relative py-4 pb-[calc(4.5rem+env(safe-area-inset-bottom,0px))] md:py-5 lg:pb-8",
} as const;
