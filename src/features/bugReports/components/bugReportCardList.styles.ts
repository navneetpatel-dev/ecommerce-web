export const bugReportCardListStyles = {
  ...
  reportNumber: "font-mono text-[0.75rem] tabular-nums text-ink-muted",
  title: "line-clamp-2 font-medium text-ink group-hover:text-brand",
  description: "line-clamp-2 text-[0.875rem] text-ink-muted",
