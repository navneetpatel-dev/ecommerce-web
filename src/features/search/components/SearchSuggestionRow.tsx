...
function SuggestionThumb({
  ...
  return (
    ...
    >
      {name.trim() ? (
        <span className="font-display text-[0.9375rem] leading-none tracking-tight">
    ...
    >
      ...
      <span className="min-w-0 flex-1">
        <span className="flex items-center gap-2">
          <span
            className={cn(
              'truncate text-[0.9375rem] font-medium leading-snug text-ink transition-colors',
        ...
        <span className="mt-0.5 flex min-w-0 items-center gap-2">
          ...
          {meta ? (
            <span className="truncate text-[0.8125rem] text-ink-muted">{meta}</span>
          ) : null}
        </span>
      </span>
