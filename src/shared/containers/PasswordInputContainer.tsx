...
import { PasswordInput, type PasswordInputProps } from '@/shared/components/ui/input'
...
export const PasswordInputContainer = React.forwardRef<HTMLInputElement, PasswordInputContainerProps>(
  (props, ref) => {
