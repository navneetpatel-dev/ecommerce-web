    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Choose which cookies you allow. Necessary cookies are always on because they keep the site working.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          <div className="flex items-start justify-between gap-4 rounded-md border border-line bg-surface p-4">
            <div>
              <p className="text-[0.9375rem] font-medium text-ink">Necessary</p>
          ...
          <div className="flex items-start justify-between gap-4 rounded-md border border-line bg-surface p-4">
            <div>
              <p className="text-[0.9375rem] font-medium text-ink">Analytics</p>
              <p className="mt-1 text-[0.8125rem] text-ink-muted">
          ...
          <div className="flex items-start justify-between gap-4 rounded-md border border-line bg-surface p-4">
            <div>
              <p className="text-[0.9375rem] font-medium text-ink">Marketing</p>
              <p className="mt-1 text-[0.8125rem] text-ink-muted">
