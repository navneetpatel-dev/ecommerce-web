    ...
    return (
      ...
      >
        ...
        <input
          ...
          className={cn(
            'min-w-0 flex-1 bg-transparent px-4 text-[0.9375rem] tabular-nums text-ink outline-none',
        ...
        {suffix ? (
          <span className="flex shrink-0 items-center px-3 text-[0.8125rem] font-medium text-ink-muted">
            {suffix}
          </span>
        ) : null}
