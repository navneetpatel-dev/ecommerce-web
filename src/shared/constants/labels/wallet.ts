...
export const walletLabels = {
  ...
  walletColumnAmount: "Amount",
  walletColumnBalance: "Balance",
  ...
  walletRechargeBelowMin: "Enter at least {min} per recharge",
  walletRechargeAboveMax: "Maximum recharge amount is {max}",
  walletMaxBalanceReached:
