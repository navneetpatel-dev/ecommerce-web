...
export const authLabels = {
  ...
  otpSent: "A new code has been sent. Check your email.",
  otpRequestFailed: "Could not send a sign-in code. Try again shortly.",
  otpVerifyFailed: "That code is invalid or has expired.",
