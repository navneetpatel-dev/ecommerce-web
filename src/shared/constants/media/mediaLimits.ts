/** Shared ticket + bug attachment limits — mirrors backend `@core/media`. */
...
/** Always attempt compression for ticket/bug videos (keeps S3 free of raw camera files). */
export const VIDEO_COMPRESS_THRESHOLD_BYTES = 0
